...
function getFFprobeWrappedExecution(input) {
    ...
    if (typeof input === 'string') {
        return execa(node_ffprobe_installer_1.path, __spreadArray(__spreadArray([], params, true), [input], false));
    }
    if (isStream(input)) {
        return execa(node_ffprobe_installer_1.path, __spreadArray(__spreadArray([], params, true), ['-i', 'pipe:0'], false), {
            reject: false,
            input: input,
        });
    }
